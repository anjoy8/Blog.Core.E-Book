...
公众号，后期调整：[文章](https://mvp.neters.club/)  
...
8、支持自由切换多种数据库，Sqlite/SqlServer/MySql/PostgreSQL/Oracle/达梦/金仓；  
...
3、目前已经有超过100多家公司在生产环境中使用，当然实际中更多，具体查看 [点击查看使用的情况](https://github.com/anjoy8/Blog.Core/issues/75)。   
